    ...
    <div>
      <section className="card">
        ...
        <div className="controls">
          ...
          <span className="muted">…or just click the map. The basemap is loaded from OpenStreetMap, so its tile server sees the map area shown, and with it the approximate station location; your flow series are never sent.</span>
        </div>
        <div className="controls">
