  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="brand">
          ...
          <div>
            ...
            <p className="tagline">Evaluate hydrological model performance beyond conventional NSE or KGE with shift-tolerant metrics.</p>
          </div>
        </div>
      ...
      <footer className="footer">
        <span>All computation runs in the browser; your flow series never leave this page. The fonts are served with the app; the Map tab loads OpenStreetMap tiles for the station's area.</span>
        <span>
          v{APP_VERSION_SHORT} ·{' '}
